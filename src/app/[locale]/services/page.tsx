      ...
      <Section bg="cream">
        <div className="grid gap-6 md:grid-cols-2">
          {services.map((service) => (
            <div
              key={service.key}
              className="bg-white p-10 border border-[#e5e1d6] hover:border-[#a12d2d]/40 transition-all duration-300 relative"
            >
              <span className="absolute top-8 right-8 font-serif text-3xl text-[#a12d2d]/70">
                {service.num}
              </span>
              <div className="flex h-14 w-14 items-center justify-center text-[#a12d2d] mb-6">
                {service.icon}
              </div>
